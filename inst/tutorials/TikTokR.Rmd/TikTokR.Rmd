...
tiktok$shareCount <- log10(tiktok$shareCount)
tiktok$playCount <- log10(tiktok$playCount)
tiktok$commentCount <- log10(tiktok$commentCount)
tiktok$diggCount <- log10(tiktok$diggCount)
colnames(tiktok) <- c("UserID", "shareMetric", "playMetric","commentMetric","diggMetric")
```
...
plot(log10(tiktok$playMetric), log10(tiktok$diggMetric))
```
