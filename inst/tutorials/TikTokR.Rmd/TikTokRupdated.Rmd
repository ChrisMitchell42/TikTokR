...
Let's have a look at this tiktok data below. Firstly just have a glance at the different headings there are and the sort of values that are displayed. From this TikTok data, we can use objects to group certain Tiktok creators together. For example if we wanted to look at the Tiktok creators who have more than 50 share counts on their video (you might need to scroll across the data to find the share count column), we can subset Tiktok creators who have a share count greater than 50 to the object tiktok_sharecount_greater_than_50 by doing this: 
...
insert median chunk
insert standard deviation chunk
insert scattergraph
...
**Well done, you have made it to the end of the tutorial and can relax! Hopefully you are feeling slightly more relaxed about using R and even learnt a few skills that you can carry onto the next tutorial.**
