...
Now that we know how R can classify some basic types of information, we will now learn how to store them. R allows you to save data by storing it inside an R object. **What is an object?** An object is just a name that you can use to call up stored data. For example, you can save data into an object. So for example if you're given raw data about different Tiktok creators, we can assign them for e.g. their gender or nationality. Wherever R encounters the object, it will replace it with the data saved inside. 
